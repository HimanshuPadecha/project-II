    ...
    <>
      ...
      <motion.div variants={itemVariants} className="max-w-3xl mb-12">
        <h1 className="text-5xl font-extrabold mb-4 leading-tight">
          Your Journey, <br />
          <span className="text-primary">Simplified &amp; Elegant.</span>
        </h1>
        <p className="text-lg text-slate-400">
          Experience the next generation of Indian Railways booking with
          seamless speed and premium reliability.
        </p>
      </motion.div>
    </>
  );
