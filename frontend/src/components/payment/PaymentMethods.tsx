    ...
    <motion.div variants={itemVariants} className="lg:col-span-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="md:col-span-1 space-y-2">
          <button className="w-full flex items-center gap-3 px-4 py-4 rounded-lg bg-primary text-white transition-all shadow-lg shadow-primary/20">
            <span className="material-icons">qr_code_2</span>
            <span className="font-medium text-sm">UPI</span>
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-4 rounded-lg hover:bg-surface-dark text-slate-400 transition-all border border-transparent hover:border-primary/20">
        ...
        <div className="md:col-span-3 bg-surface-dark rounded-xl border border-primary/10 p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <button className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-primary bg-primary/5 group transition-all">
              ...
              <button className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-slate-700 hover:border-primary/50 transition-all">
            ...
            <div className="space-y-4">
              <div className="relative">
                <input className="w-full bg-background-dark border border-slate-700 rounded-lg px-4 py-3 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-slate-600" placeholder="e.g. mobile-number@upi" type="text" />
                <div className="absolute right-3 top-3 text-xs font-bold text-primary">VERIFY</div>
              </div>
